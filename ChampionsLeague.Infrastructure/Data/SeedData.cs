...
public static class SeedData
{
    ...
    // - Matchday 1 (Apr 10): sale CLOSED  — is in the past
    // - Matchday 2 (Apr 26): sale OPEN  — within 1 month window
    ...
    {
        var d1 = new DateTime(2026, 4, 10, 20, 45, 0, DateTimeKind.Utc); // Matchday 1 — OPEN
        var d2 = new DateTime(2026, 4, 26, 20, 45, 0, DateTimeKind.Utc); // Matchday 2 — OPEN
