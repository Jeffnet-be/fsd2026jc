...
/// <summary>ViewModel for a single row in the match calendar list (DataTable).</summary>
...
/// <summary>ViewModel for the match detail page, including sector availability.</summary>
