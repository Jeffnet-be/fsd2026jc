...
public class TranslationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _t = new()
    {
        ...
        // ── Home page ─────────────────────────────────────────────────
        ["home_hero_title"] = new(){
            ["nl"]="Ticket Portal", ["fr"]="Portail Billetterie", ["en"]="Ticket Portal" },
        ...
        ["home_view_calendar"] = new(){
            ["nl"]="Bekijk wedstrijdkalender", ["fr"]="Voir le calendrier", ["en"]="View Match Calendar" },
        ["home_create_account"] = new(){
            ["nl"]="Account aanmaken", ["fr"]="Créer un compte", ["en"]="Create Account" },
        ["home_clubs_title"] = new(){
            ["nl"]="Deelnemende clubs", ["fr"]="Clubs participants", ["en"]="Participating Clubs" },
        ...
        ["login_invalid"]     = new(){ ["nl"]="Ongeldig e-mailadres of wachtwoord.", ["fr"]="Email ou mot de passe invalide.", ["en"]="Invalid email or password." },
